...
class Seo
{
    ...
    public function analyze($url, $content = null)
    {
        ...
        $titlePoint     =    strlen($title) < 71  && strlen($title) > 60  ? 10 : 5;
        $descPoint      =    strlen($description) < 160  && strlen($description) > 145  ? 10 : 5;
        $h1Point        =    $fullPageResult['headers']['h1']['count'] == 1  ? 10 : 5;
        $h2Point        =    $fullPageResult['headers']['h2']['count'] > 1 && $fullPageResult['headers']['h2']['count'] < 4  ? 10 : 5;
        $h3Point        =    $fullPageResult['headers']['h3']['count'] > 1 && $fullPageResult['headers']['h3']['count'] < 5  ? 10 : 5;
        $h4Point        =    $fullPageResult['headers']['h4']['count'] > 1 && $fullPageResult['headers']['h4']['count'] < 6  ? 10 : 5;
        $h5Point        =    $fullPageResult['headers']['h5']['count'] > 1 && $fullPageResult['headers']['h5']['count'] < 6  ? 10 : 5;
        $h6Point        =    $fullPageResult['headers']['h6']['count'] > 1 && $fullPageResult['headers']['h6']['count'] < 6  ? 10 : 5;
        $imagesPoint    =    $fullPageResult['images']['count'] === $fullPageResult['images']['count_alt'] ? 10 : 5 ;
        $keywordsPoint  =    count($fullPageResult['keywords']) > 25 ? 10 : 5;
        ...
        $points = [
              ...
              'keywordsPoint' => $keywordsPoint,
              'allPoints'     => $titlePoint + $descPoint + $h1Point + $h2Point + $h3Point + $h4Point + $h5Point + $h6Point + $imagesPoint + $keywordsPoint,
        ];
        ...
        $result = [
            ...
            'analyze_id'  => Carbon::now()->timestamp,
    ...
    private function findKeywords($content, $min = 3)
    {
        ...
        if ($this->language == 'fa-IR') {
            ...
            $words = str_word_count(strtolower(implode(', ', $meta)), 1);
        }
